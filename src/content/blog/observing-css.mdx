...
image: '/blog/images/embed-observing-css-properties.webp'
---
...
[Skip to the source code section](#source-code).
:::
...
This shows or hides the disclosure button depending on whether `--affordance` has a value of `disclosure`.

Let’s review how the actual observer is coded.

### Source Code

Jump ahead to read how it works.
